                ...
                <div class="flex justify-center">
                    <div class="w-full flex">
                        <div class="w-[70%] h-auto px-[20px]">
                            ...
                            <div class="mt-[10px] h-auto w-[500px]">
                                <div class="w-auto h-[180px] pr-[20px]" style="overflow-y: auto">
                                    @foreach ($comments as $comment)
                                        <div
                                            class="w-full  min-h-[65px] rounded-[5px] flex">
                                            <img class="mt-[10px] w-[28px] h-[28px] rounded-[50%] ml-[20px]"
                                ...
                                <form action="{{ route('inbox.comment.store', $task->id) }}" method="post">
                                    @csrf
                                    <div class="border-t border-gray-300 flex w-full h-[70px] items-center px-[10px]">
                                        <div class="w-[80%] h-fill">
                                            <input name="content" placeholder="Tambahkan komentar ..."
                                                class="w-full h-[30px] border-[1px] border-gray-300 focus:outline-none focus:border-gray-500 rounded-[5px] px-[5px] text-[14px]"
                                                type="text">
                                        </div>
                                        <div class="w-[20%] h-fill">
                                            <button type="submit"
                                                class="w-[30px] h-[30px] items-center flex cursor-pointer ml-[20px] bg-gray-300 justify-center rounded-[5px]">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-gray-500"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M10.5 13.5L21 3M21 3l-6.5 18-4-7-7-4 18-7z" />
                                                </svg>
                                            </button>
                        ...
                        <div class="w-[30%] px-[20px] h-[71.4vh] bg-[#ECEEF0]"
                            ...
                            <div class="w-full h-auto mt-[20px]">
                                ...
                                <div class="h-[30px] flex items-center">
                                    ...
                                    @endif
                                    <p class="text-[12px] ml-[4px] ">{{ $task->category->name ?? 'Inbox' }}</p>
                                </div>
