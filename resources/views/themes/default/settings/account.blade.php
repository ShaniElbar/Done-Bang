    ...
    <div class="w-full h-[100vh] bg-black absolute bg-black/50 flex justify-center items-center">
        ...
        <div class="w-[80%] h-[75vh] bg-white flex rounded-[15px]">
            <div class="w-[20%] px-[15px] h-[75vh] bg-[#ECEEF0]"
                ...
                @php
                    $isActive = request()->is('app/inbox/account');
                    $Theme = request()->is('');
                @endphp
            ...
            <div class="w-[80%] h-[75vh]  bg-white" style="border-top-right-radius: 15px; border-bottom-right-radius: 15px">
                ...
                <div class="w-full h-[67vh] pb-[30px]" style="overflow-y: auto">
                    ...
                    <div class="flex items-center gap-4 px-2.5">
                        ...
                        <div class="flex flex-col sm:flex-row gap-2">
                            ...
                            <form action="{{ route('user.update.photo') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <label for="photo"
                                    class="inline-flex items-center h-8 px-3 bg-gray-200 hover:bg-gray-300 rounded-md cursor-pointer transition-colors">
                    ...
                    <div class=" mt-[30px] ml-[10px]">
                        ...
                        <a href="{{ route('inbox.themes.default.settings.email') }}">
                            <div
                                class="mt-[10px] w-[130px] justify-center h-[30px] rounded-[5px] hover:bg-gray-400 transition cursor-pointer bg-gray-300 flex items-center">
                                <p class="text-[14px]">Change Email</p>
                            </div>
                        </a>
                    </div>
                    <div class=" mt-[30px] ml-[10px] mr-[10px]  border-b-[1px] border-b-[#ECEEF0] py-[10px]">
                    ...
                    <div class="px-[10px] mt-[10px]  border-b-[1px] border-b-[#ECEEF0] h-auto py-[20px]">
                        <p class="font-[600]">Connected accounts</p>

                        <p class="text-[14px]">You can log in to Todoist with your Google account <span
                                class="font-[700]">{{ $user->email }}</span></p>
                        <p class="text-[14px] mt-[10px]">You haven't set a password yet, so we can't disconnect your Google
                            account. Please <a href="{{ route('inbox.themes.default.settings.password') }}"><u>create a
                                    password</u></a> first to proceed</p>
                    </div>
