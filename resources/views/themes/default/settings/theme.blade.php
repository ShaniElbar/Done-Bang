        ...
        <div class="w-[80%] h-[75vh] bg-white flex rounded-[15px]">
            <div class="w-[20%] px-[15px] h-[75vh] bg-[#ECEEF0]"
                ...
                <a href="{{ route('inbox.themes.default.settings.account') }}">
                    <div
                        class="w-full h-[30px] flex items-center mt-[10px] hover:bg-gray-300 px-[5px] rounded-[5px] cursor-pointer ">
                ...
                <a href="{{ route('inbox.themes.default.settings.theme') }}">
                    <div
                        class="w-full h-[30px] flex items-center hover:bg-gray-300 px-[5px] rounded-[5px] cursor-pointer {{ request()->is('app/inbox/theme*') ? 'bg-gray-400' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
