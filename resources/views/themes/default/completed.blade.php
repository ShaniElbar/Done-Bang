...
@section('main-content')
    <div class="mb-[40px]">
        ...
        {{--  --}}
        <div id="show-project-menu" class="ml-[20px] absolute hidden  w-[300px]  bg-white rounded-md mt-1  shadow-lg"
            style="z-index: 1000;">
            ...
            <div class="project-item px-3 py-2 cursor-pointer hover:bg-gray-200" data-value="notnull">
                ...
                <div class="flex items-center">
                    ...
                    <p class="ml-[10px] text-gray-700">All Project</p>
                </div>
            </div>
            ...
            <div class="project-item px-3 py-2 cursor-pointer hover:bg-gray-200" data-value="null">
                ...
                <div class="flex items-center">
                    ...
                    <p class="ml-[10px] text-gray-700">Inbox</p>
                </div>
            </div>
            ...
            <div class="px-3 py-2 cursor-pointer hover:bg-gray-200">
                ...
                <div class="flex items-center">
                    ...
                    <p class="ml-[10px] text-gray-700 font-[500]">My Project</p>
                </div>
            </div>
        ...
        <div class="flex">
            <div class="w-full h-[78px] flex items-center border-b border-b-[1px] border-[#b8b8b8]">
                <div class="relative w-full h-[50px] px-[5px] flex items-center">
                    <img class="w-[49px] h-[49px] rounded rounded-[50%]" src="{{ asset('storage/' . $item->user->photo) }}"
                        alt="">
                    ...
                    <div class="w-[700px] h-[50px] ml-[10px]">
                        <div class="w-[700px]">
                            ...
                            @endif
                                ...
                                </b> completed a task: <u>{{ $item->task_name }}</u></p>
                        </div>
                    ...
                    <div class=" w-[100px] h-[50px] ml-[10px]">
                        ...
                        <div class="text-[12px] text-gray-700 flex items-center">
