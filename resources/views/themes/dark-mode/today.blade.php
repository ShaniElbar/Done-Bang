...
@section('main-content')
    <div class="w-full h-auto">
        ...
        <section>
            <p class="text-[26px] font-[700]">Today</p>
        </section>
        <div class="flex ml-[5px] items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16"
                aria-hidden="true" class="siIBvPn">
                <path fill="#868686" fill-rule="evenodd"
            ...
            <p class="text-[14px] ml-[5px]  text-[#868686]">{{ $taskCount }}</p>
            <p class="text-[14px] ml-[5px] text-[#868686]">Tasks</p>
        </div>
                    ...
                    @foreach ($overdueData as $item)
                        <div class="draggable-item" data-id="{{ $item->id }}" draggable="true">
                            <div class="w-full p-[10px] h-auto flex cursor-pointer">
                                ...
                                <div class="ml-[10px] w-[70%]">
                                    ...
                                    @php
                                        ...
                                        $diffInSeconds = $currentDateTime - $taskTimestamp;
                                        $isToday = $taskDate->isToday();
                                        $isLate = $taskTimestamp < $currentDateTime;
                                        $isMoreThanOneDayLate = $diffInSeconds > 86400;

                                        $displayText = $isMoreThanOneDayLate
                                            ? date('d M', $taskTimestamp)
                                            : ($isToday
                                                ? date('H:i', $taskTimestamp)
                                                : $taskDate->translatedFormat('l'));

                                        $finalColor = $isMoreThanOneDayLate
                                            ? '#ff2626'
                                            : ($isToday
                                                ? ($isLate
                                                    ? '#ff2626'
                                ...
                                <div>
                                    <div class="flex">
                                        ...
                                        <div class="taskMoreShow hidden absolute w-[200px] h-auto rounded rounded-[10px] bg-[#121212] right-[5%]"
                            ...
                            <div class="w-full flex justify-center">
                                <div class="w-[90%] border-b border-b-[1px] border-[#2d2d2d]"></div>
                            </div>
                        </div>
                    @endforeach
        ...
        <div>
            <div class="font-[700] flex w-full justify-center items-center" id="drag-container">
                <div class="w-[90%] border-b border-b-[1px] h-[30px] border-[#2d2d2d]">
                    <p>{{ now()->format('d M') }} • Today • {{ now()->format('l') }}</p>
                </div>
            ...
            <div class="w-full flex justify-center ">
                <div class="w-[90%]  cursor-pointer">
                    <div class="mt-[5px] flex items-center">
                        ...
                        <p class="text-[14px] ml-[10px] text-white">Add Task</p>
                    </div>
                </div>
            </div>
        </div>
