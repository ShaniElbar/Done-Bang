...
@section('main-content')
    <div class="w-full h-auto">
        <section>
            <p class="text-[26px] font-[700]">{{ $categoryDetail->name }}</p>
    ...
    <div class="w-full h-[300px] flex items-center justify-center">
        <div class="">
            <img class="w-[220px] h-[200px]"
                src="https://d3ptyyxy2at9ui.cloudfront.net/assets/images/9b83bf5d1895df53ed06506fd3cd381c.png" alt="">
            <div>
                <p class="font-[600]">What do you need to get done today?</p>
            </div>
            <div class="w-full flex justify-center">
                <div class="w-[260px] flex justify-center">
                    <p style="text-align: center" class="mt-[10px] text-gray-700 text-[14px]">By default, tasks added here will be scheduled for today.</p>
                </div>
            </div>
        </div>
    </div>
