...
<body>
    ...
    <div class="flex w-full h-auto">
        <div class="w-[22%] h-[100vh] bg-[#1E1E1E] p-[15px] text-[#FFFFFF]">
            <div class="w-full h-[33px] flex items-center rounded rounded-[5px] text-[#202020]">


                <div id="profile"
                    class="transition rounded rounded-[6px] flex items-center pr-[10px] h-[33px] cursor-pointer hover:bg-[#2D2D2D]">
                ...
                <div id="proMore" style="display: none">
                    <div style="box-shadow: 0px 4px 10px rgba(0,0,0,0.2)"
                        class="text-white absolute w-[285px] h-auto bg-[#2D2D2D] rounded rounded-[10px] top-[50px] left-[10px]">
                        <div style="border-top-right-radius: 10px; border-top-left-radius: 10px"
                            class="p-[6px] w-full h-auto bg-[#252525] ">
                        ...
                        <a href="{{ route('inbox.themes.dark-mode.settings.account') }}">
                            <div class="p-[6px] w-full h-auto bg-[#252525] mt-[1px] ">
                                <div
                        ...
                        <div class="p-[6px] w-full h-auto bg-[#252525] mt-[1px] ">
                            <a href="{{ route('themes.dark-mode.completed') }}">
                                <div
                                    class="w-full h-[32px] flex items-center rounded rounded-[5px] cursor-pointer hover:bg-[#B8B8B8] transition">
                                    <div class="ml-[5px] flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div style="border-bottom-right-radius: 10px; border-bottom-left-radius: 10px"
                            class="p-[6px] w-full h-auto bg-[#252525] mt-[1px] ">
                ...
                <div
                    class="transition cursor-pointer hover:bg-[#2D2D2D] ml-[60px] w-[32px] h-[32px] rounded rounded-[6px] ml-[10px] flex items-center justify-center">
            ...
            <div class="addtask">
                <div id="addtask"
                    class=" w-full h-[33px] flex items-center rounded rounded-[5px] cursor-pointer hover:bg-[#383838] mt-[20px] transition">
                    <div class="ml-[5px] flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24">
                            <path fill="#FFFFFF" fill-rule="evenodd"
                    ...
                    <div id="hidden-add"
                        class="absolute left-[270px] h-[27px] bg-[#2D2D2D] pl-[10px] pr-[10px] rounded rounded-[5px]">
                        <div class="w-full h-[27px] flex items-center">
            ...
            <div style="overflow-y: auto" class="w-full h-[75vh]">
                <div id="search"
                    class=" w-full h-[33px] flex items-center rounded rounded-[5px] cursor-pointer hover:bg-[#383838] mt-[5px] transition">
                    <div class="ml-[5px] flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                            viewBox="0 0 24 24">
                            <path fill="#FFFFFF" fill-rule="evenodd"
                ...
                <a href="{{ route('themes.dark-mode.today') }}">
                    <div id="today"
                        class="w-full h-[33px] flex items-center rounded rounded-[5px] cursor-pointer hover:bg-[#383838] mt-[5px] transition  {{ Request::is('app/today/dark') ? 'bg-[#383838]' : 'hover:bg-[#2D2D2D]' }}">
                        <div class="ml-[5px] flex items-center">
                ...
                <a href="{{ route('themes.dark-mode.inbox') }}">
                    <div id="inbox"
                        class="w-full h-[33px] flex items-center rounded-[5px] cursor-pointer mt-[5px] transition 
                    {{ Request::is('app/inbox/dark') ? 'bg-[#2D2D2D]' : 'hover:bg-[#2D2D2D]' }}">
                        <div class="ml-[5px] flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                            ...
                            <div class="ml-[10px]">
                                <p class="text-[13px] {{ Request::is('app/inbox/dark') ? 'text-white' : '' }}">Inbox</p>
                            </div>
                        </div>
                ...
                <a href="{{ route('themes.dark-mode.upcoming') }}">
                    <div id="upcoming"
                        class="w-full h-[33px] flex items-center rounded rounded-[5px] cursor-pointer hover:bg-[#383838] mt-[5px] transition {{ Request::is('app/upcoming/dark') ? 'bg-[#383838]' : 'hover:bg-[#2D2D2D]' }}">
                        <div class="ml-[5px] flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                                <path fill="#FFFFFF" fill-rule="evenodd"
                ...
                <a href="{{ route('themes.dark-mode.completed') }}">
                    <div id="complet"
                        class="w-full h-[33px] flex items-center rounded rounded-[5px] cursor-pointer hover:bg-[#383838] mt-[5px] transition {{ Request::is('app/completed/dark') ? 'bg-[#2D2D2D]' : 'hover:bg-[#2D2D2D]' }}">
                        <div class="ml-[5px] flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                viewBox="0 0 24 24">
                                <path fill="#FFFFFF" fill-rule="evenodd"
                ...
                @if ($favorit->contains('favorit', '1'))
                    <div
                        class="w-full h-[33px] flex items-center mt-[20px] rounded rounded-[5px] pl-[5px] cursor-pointer hover:bg-[#2D2D2D] transition">
                ...
                @foreach ($favorit as $item)
                    <a href="{{ route('themes.dark-mode.project', ['id' => $item->id]) }}">
                        <div class="menuHover">
                            <div
                                class="w-full h-[33px] flex items-center rounded rounded-[5px] cursor-pointer hover:bg-[#2D2D2D] mt-[5px] transition {{ Request::segment(2) === 'project' && Request::segment(3) == $item->id ?  'bg-[#383838]' : 'hover:bg-[#2D2D2D]' }}">
                                <div class="ml-[5px] flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                @foreach ($category as $item)
                    ...
                    <div data-id="{{ $item->id }}"
                        class="text-white tooltip item absolute w-[300px] h-auto hidden  rounded rounded-[10px] bg-[#252525] top-[40%] left-[20%] text-black"
                        style="box-shadow: 0px 4px 10px rgba(0,0,0,0.2); z-index: 1000">


                        <div class="w-full h-auto py-[10px] px-[10px] bg-[#1E1E1E]"
                            style="border-top-left-radius: 10px; border-top-right-radius: 10px">

                            <div class="shower-add-project" data-id="{{ $item->id }}">
                                <div
                                    class="w-full h-[35px] hover:bg-[#2D2D2D] px-[5px] flex items-center text-[13px] rounded rounded-[5px] cursor-pointer">
                        ...
                        <div class="w-full h-auto py-[10px] px-[10px] bg-[#1E1E1E] mt-[1px]">
                            <div class="w-full h-[35px] hover:bg-[#2D2D2D] px-[5px] flex items-center text-[13px] rounded rounded-[5px] cursor-pointer"
        ...
        <div class="w-[78%] h-[100vh] text-white bg-[#121212] p-[70px]" style="overflow-y: auto">
            @yield('main-content')
        </div>



        <div id="showAddTask" style="display: none" class="absolute w-full h-[100vh] bg-black/70">
            <div class="w-full h-[100vh] flex items-center justify-center">
                <form action="{{ isset($task) ? route('task.update', $task->id) : route('inbox.task.store') }}" method="POST">
                    @csrf
                    @if (isset($task))
                        @method('PUT')
                    @endif
        
                    <div class="w-[750px] h-[90vh] rounded rounded-[10px] bg-[#1E1E1E] flex border border-[#2d2d2d]">
        
                        <div class="w-[500px] h-auto">
                            <div class="w-full h-auto p-[30px]">
                                <div>
                                    <p class="text-[22px] font-[600] text-white">
                                ...
                                <div class="mt-[20px]">
                                    <input name="task_name" type="text" placeholder="Task name"
                                        ...
                                        class="text-[14px] pl-[10px] pr-[10px] w-full h-[40px] border border-[#383838] rounded-[5px] focus:outline-none focus:ring-1 focus:ring-blue-500 bg-[#2d2d2d] text-white transition duration-500">
                                </div>
                                <div class="mt-[20px]">
                                    <textarea name="description" placeholder="Description"
                                        class="resize-none text-[14px] p-[10px] w-full h-[210px] border border-[#383838] rounded-[5px] focus:outline-none focus:ring-1 focus:ring-blue-500 bg-[#2d2d2d] text-white transition duration-500">{{ old('description', $task->description ?? '') }}</textarea>
                                </div>
                            </div>
                            <div class="mt-[60px]">
                                <div class="w-full h-[80px] flex" style="border-top: 2px solid #252525">
                                    <div class="w-[50%]"></div>
                                    <div class="w-[50%] h-[70px] flex items-center">
                                        <button type="button" id="closeAdd"
                                            class="ml-[20px] cursor-pointer hover:bg-[#2d2d2d] hover:border hover:border-[#2d2d2d] hover:text-white transition duration-300 w-auto rounded rounded-[5px] h-[40px] border-[#383838] text-white pr-[10px] pl-[10px]">Cancel</button>
                                        <button type="submit"
                                            class="ml-[10px] cursor-pointer hover:bg-blue-600 transition duration-300 w-auto rounded-[5px] h-[40px] bg-blue-500 text-white px-[10px]">
                        ...
                        <div class="w-[250px] h-auto border-[#252525] p-[20px] border-l border-[#2d2d2d]"
                            style="border-top-right-radius:9px;border-bottom-right-radius:9px;">
                            <div>
                                <p class="text-[13px] text-gray-400">Create in</p>
                            </div>
        
                            <div class="mt-[10px] relative">
                                <div id="dropdown-btn"
                                    class="w-full h-[40px] pl-[7px] pr-[7px] rounded-[5px] focus:outline-none hover:bg-gray-600 cursor-pointer transition flex items-center justify-between">
                                    <div class="flex items-center">
                                        <img class="w-[25px] h-[25px] rounded-full object-cover"
                                        src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('images/profileEmpty.png') }}"
                                        alt="Profile Photo">
                                        <span id="selected-category" class="ml-[10px] text-gray-300"></span>
                                        <p id="selected-dummy" class="text-gray-300">Inbox</p>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="none" viewBox="0 0 18 19" class="arrow-icon">
                                        <path stroke="#9CA3AF" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div id="dropdown-menu"
                                    class="absolute w-[250px] bg-gray-800 rounded-md mt-1 hidden shadow-lg border border-[#2d2d2d]"
                                    style="z-index: 1000">
                                    <div id="searcher" class="w-full h-[40px] flex items-center px-[10px]"
                                        style="border-bottom: 1.5px solid #2D3748">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <input type="text" placeholder="Search..."
                                            class="w-full pl-[5px] focus:outline-none bg-gray-800 text-white">
                                    </div>
                                    @foreach ($category as $item)
                                        <div class="dropdown-item px-3 py-2 cursor-pointer hover:bg-gray-700"
                                            data-value="{{ $item->id }}">
                                            <div class="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    fill="none" viewBox="0 0 24 24" class=""
                                                ...
                                                <p class="ml-[10px] text-gray-300">{{ $item->name }}</p>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="mt-[10px]">
                                <p class="text-[13px] text-gray-400">Schedule this task for</p>
                            </div>
                            ...
                            <div class="mt-[10px] relative">
                                <div id="date-btn"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span id="selected-date" class="ml-[10px] text-gray-300 w-[150px]">Pilih Tanggal</span>
                                    </div>
                                    <div class="ml-[0px]">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="none" viewBox="0 0 18 19" class="arrow-icon">
                            ...
                            <div class="mt-[10px]">
                                <p class="text-[13px] text-gray-400">Priority</p>
                            </div>
                            ...
                            <div class="mt-[10px] relative">
                                ...
                                <div id="priorityBtn"
                                    class="w-full h-[40px] pl-[7px] pr-[7px] rounded-[5px] focus:outline-none hover:bg-gray-600 cursor-pointer transition flex items-center">
                                    <div class="w-full flex items-center">
                                        ...
                                        <p class="ml-[10px] text-[16px] text-gray-300">Priority 4</p>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="none" viewBox="0 0 18 19" class="arrow-icon">
                                        <path stroke="#9CA3AF" stroke-linecap="round" stroke-linejoin="round"
                                ...
                                <div id="priority-menu"
                                    ...
                                    <div class="w-full h-[40px] flex items-center px-[10px]"
                                        style="border-bottom: 1.5px solid #2D3748">
                                        <p class="text-gray-300">Priority</p>
                                    </div>
        
                                    <div class="priority-item px-3 py-2 cursor-pointer hover:bg-gray-700"
                                        data-value="1">
                                        <div class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                fill="#D84040" viewBox="0 0 24 24">
                                            ...
                                            <p class="ml-[10px] text-gray-300">Priority 1</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="priority-item px-3 py-2 cursor-pointer hover:bg-gray-700"
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <p class="ml-[10px] text-gray-300">Priority 2</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="priority-item px-3 py-2 cursor-pointer hover:bg-gray-700"
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <p class="ml-[10px] text-gray-300">Priority 3</p>
                                        </div>
                                    </div>
                                    <div class="priority-item px-3 py-2 cursor-pointer hover:bg-gray-700 hover:rounded-b-[5px]"
                                        data-value="4">
                                        <div class="flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <p class="ml-[10px] text-gray-300">Priority 4</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-[10px]">
                                <p class="text-[13px] text-gray-400">Pick Time</p>
                            </div>
                            ...
                            <div id="dropdown-btn"
                                ...
                                <svg width="24" height="24" viewBox="0 0 100 100"
                                    ...
                                    <circle cx="50" cy="50" r="45" stroke="#9CA3AF" stroke-width="4"
                                        fill="#2D3748" />
                                    ...
                                    <text x="48" y="18" font-size="10" text-anchor="middle" fill="#9CA3AF">12</text>
                                    <text x="85" y="55" font-size="10" text-anchor="middle" fill="#9CA3AF">3</text>
                                    <text x="50" y="92" font-size="10" text-anchor="middle" fill="#9CA3AF">6</text>
                                    <text x="15" y="55" font-size="10" text-anchor="middle" fill="#9CA3AF">9</text>
                                </svg>
        
                                <input name="time" type="text" id="timepicker"
                                    class="custom text-gray-300 ml-[10px] w-full border-none bg-transparent focus:outline-none cursor-pointer"
        ...
        <div id="addProject" class="hidden absolute text-white w-full h-[100vh] bg-black/80">
            ...
            <div class="w-full h-[100vh] flex items-center justify-center">
                <form
                    ...
                    @if (isset($project))
                        @method('PUT')
                    @endif
                    <div class="w-[480px] h-[400px] bg-[#1E1E1E] rounded rounded-[10px]">
                        <div class="w-full h-[50px] flex items-center border-b border-b-[1px] border-b-[#2D2D2D]">
                        ...
                        <div class="w-full h-[290px] p-[15px]" style="overflow-y: auto">
                            ...
                            <div class="mt-[20px]">
                                <label class="font-[700] text-white">Color</label>
                                ...
                                <div id="colorBtn"
                                    ...
                                    <div class="w-full flex items-center">
                                        ...
                                        <p class="ml-[10px] text-[14px] text-white">{{ $colorName }}</p>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="none" viewBox="0 0 18 19" class="arrow-icon">
                                ...
                                <div id="color-menu"
                                    class="p-[10px] absolute hidden w-[450px] bg-[#2D2D2D] rounded-md mt-1  shadow-lg"
                                    style="z-index: 1000;">
                                    <div class="w-full h-[40px] flex items-center px-[10px]"
                                        style="border-bottom: 1.5px solid #1E1E1E  ">
                                    ...
                                    <div style="overflow-y: auto" class="h-[200px]">
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            ...
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Crimson Red</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#FF4500">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Sunset Orange</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#32CD32">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Neon Lime</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#50C878">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Emerald Green</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#008080">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Ocean Teal</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#87CEEB">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Sky Blue</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#191970">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Midnight Blue</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#7851A9">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Royal Purple</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#673147">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Deep Plum</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#FFB7C5">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Cherry Blossom Pink</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#F7E7CE">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Champagne Beige</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#E97451">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Burnt Sienna</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#C2B280">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Sandstone Brown</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#708090">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Slate Gray</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#B8B8B8">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Muted Silver</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#36454F">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Charcoal Gray</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#343434">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Jet Black</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#FFFFF0">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Ivory White</p>
                                            </div>
                                        </div>
                                        <div class="color-item px-3 py-2 cursor-pointer hover:bg-gray-200 hover:rounded hover:rounded-[5px]"
                                            data-value="#FFFAFA">
                                            <div class="flex items-center">
                                                ...
                                                <p class="ml-[10px] text-   ">Snow White</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="w-full flex h-[50px] flex items-center border-t border-t-[1px] border-t-[#2D2D2D]">
                            <div class="w-[100%]"></div>
                            <div class="w-full">
        ...
        <div id="searchFitur" class="hidden w-full h-[100vh] absolute flex items-center justify-center">
            ...
            <div id="showFitur" class="w-[50%] px-[10px] h-[60vh] bg-[#1E1E1E] rounded-[10px]"
                style="box-shadow: 0px 0px 10px rgba(0,0,0,0.2)">
                <div class="w-full h-[40px] flex items-center px-[10px]"
                    style="border-bottom: 1.5px solid #2D2D2D">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                    ...
                    <input type="text" id="fiturShower" placeholder="Search..."
                        class="text-[14px] text-white w-full pl-[5px] focus:outline-none">
                ...
                <div  class="px-[10px] w-full h-[52vh]" style="overflow-y: auto">
                    ...
                    <div class="pb-[10px]" style="border-bottom: 1.5px solid #2D2D2D">
            ...
            <div class="w-full h-[100vh] flex items-center justify-center">
                <form id="commentForm" method="POST">
                    ...
                    <div class="w-[480px] h-[300px] bg-white rounded rounded-[10px]">
                        ...
                        <div
                            class="w-full flex h-[50px] flex items-center border-t border-t-[1px] border-t-[#2D2D2D]">
                            <div class="w-[100%]"></div>
                            <div class="w-full">
