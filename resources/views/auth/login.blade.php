        ...
        <div class="w-[50%] h-fill">
            <div class="ml-[150px] mt-[20px]">
                ...
                <div class="ml-[10px] mt-[100px] w-[400px]">
                    <div>
                        <p class="text-[32px] font-[700]">Sign in</p>
                    </div>
                    ...
                    <form action="{{ route('auth.login.store') }}" method="POST">
                        ...
                        @if (session()->has('message'))
                            <div class="mt-[10px] w-full flex justify-center">
                                <span class="text-red-500 font-[500]">
                                    {{ session('message') }}
                                </span>
                            </div>
                        @endif
                        ...
                        <div class="mt-[20px] group">
                            <div
                                class="input-field @error('password') error @enderror  w-full h-[60px] border border-[1.5px] border-[#EEEEEE] rounded rounded-[10px] group-focus-within:border-[#B8B8B8] transition">
                                <label for=""
                        ...
                        <div class="mt-[20px]">
                            <button type="submit"
                                class="w-full h-[50px] bg-[#335166] border rounded rounded-[10px] font-[600] text-white cursor-pointer hover:bg-[#EEEEEE] hover:text-[#335166] hover:font-[600] transition">Login</button>
                        </div>
                        <div class="mt-[20px]">
                        ...
                        <div class="mt-[20px]">
                            <div class="w-full flex justify-center">
                                <p class="text-[13px]">Already signed up? <a href="{{ route('auth.register') }}">
                                        <u class="hover:text-[#335166]">Go to register</u></a></p>
                            </div>
                        </div>
